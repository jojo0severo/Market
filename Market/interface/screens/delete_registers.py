...
class DeleteRegistersScreen(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        self.from_date.setGeometry(QtCore.QRect(110, 130, 441, 321))
        font = QtGui.QFont()
        ...
        self.to_date.setGeometry(QtCore.QRect(820, 130, 431, 311))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        ...
        self.label_from_date.setGeometry(QtCore.QRect(110, 70, 551, 41))
        font = QtGui.QFont()
        ...
        self.label_to_date.setGeometry(QtCore.QRect(820, 70, 491, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        font.setPointSize(15)
        font.setStyleStrategy(QtGui.QFont.PreferAntialias)
        ...
        self.delete.setGeometry(QtCore.QRect(50, 600, 231, 111))
