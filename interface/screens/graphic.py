...
class GraphicScreen(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        # Graph
        self.mpl.setGeometry(QtCore.QRect(20, 100, 1000, 650))

        # Mean of the named months
        self.mean.setGeometry(QtCore.QRect(1070, 385, 450, 81))
        font = QtGui.QFont()
        ...
        self.label_mean.setGeometry(QtCore.QRect(970, 270, 540, 81))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Light")
        ...
        self.label_mean_coin.setGeometry(QtCore.QRect(1020, 390, 50, 71))
        font = QtGui.QFont()
        font.setFamily("Dubai")
        font.setPointSize(18)
